...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <img src="plc.jpg"   style="height:500px;"  alt="police">
            <table class="table">
                <thead>
                    <tr>
...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="h2 bg-info" style="height:750px;">
                Address:</br>
...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="h2 bg-info" style="height:790px;">
                CREATION:</br>
                ...
                4. The forensic science services uncompromising & Geese under the Development Division grew over a period.
            </div>
        </body>
        </html>
